<x-app-layout>
    ...
    <x-slot name="header">{{ __(' Source of Income/Revenue') }}</x-slot>
    <x-slot name="subHeader">{{ __('You can enter your revenue and apply here.') }}</x-slot>
                    ...
                    <div class="card-aside-wrap">
                        <div class="card-content">
                            <ul class="nav nav-tabs nav-tabs-mb-icon nav-tabs-card">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="/apply/revenue">
                                        <em class="icon ni ni-money"></em>
                            ...
                            <div class="card-inner">
                                <div class="nk-block">
                                    <div class="nk-block">
                                        ...
                                        <p>You can enter the Revenue here.</p>
                                    </div>
                                    ...
                                    @endif
                                    <form action="{{ route('revenue.save') }}" method="POST" autocomplete="off">
                                        @csrf
                                        @include('pages.apply.revenue.revenue-form')
                                    </form>

                                    @include('pages.apply.revenue.revenue-table')
                                </div>
                            </div>
                        </div>
                    </div>
